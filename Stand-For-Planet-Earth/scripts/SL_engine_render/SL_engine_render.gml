...
{
    sl_buffer_surface1 = surface_create((__view_get( e__VW.WView, global.sl_viewid )+sl_buffer_xmargin*2)*sl_buffer_texturesize,(__view_get( e__VW.HView, global.sl_viewid )+sl_buffer_ymargin*2)*sl_buffer_texturesize);
    sl_buffer_surface2 = surface_create((__view_get( e__VW.WView, global.sl_viewid )+sl_buffer_xmargin*2)*sl_buffer_texturesize,(__view_get( e__VW.HView, global.sl_viewid )+sl_buffer_ymargin*2)*sl_buffer_texturesize);
...
{
    if !surface_exists(sl_layers_surface[i1]) sl_layers_surface[i1] = surface_create((__view_get( e__VW.WView, global.sl_viewid )+sl_buffer_xmargin*2)*sl_buffer_texturesize,(__view_get( e__VW.HView, global.sl_viewid )+sl_buffer_ymargin*2)*sl_buffer_texturesize);
    ...
    for (i2=0; sl_global_list[i2,1]!=-1; i2+=1) if sl_global_list[i2,0]=i1 with sl_global_list[i2,1] if visible
     draw_sprite_ext(sprite_index,floor(image_index),(x-__view_get( e__VW.XView, global.sl_viewid )+other.sl_buffer_xmargin)*other.sl_buffer_texturesize,(y-__view_get( e__VW.YView, global.sl_viewid )+other.sl_buffer_ymargin)*other.sl_buffer_texturesize,image_xscale*other.sl_buffer_texturesize,image_yscale*other.sl_buffer_texturesize,image_angle,c_black,image_alpha);
    for (i2=0; global.sl_castlist[i2,0]!=-1; i2+=1) if global.sl_castlist[i2,0]=i1
     draw_sprite_ext(global.sl_castlist[i2,4],global.sl_castlist[i2,5],(global.sl_castlist[i2,6]-__view_get( e__VW.XView, global.sl_viewid )+sl_buffer_xmargin)*sl_buffer_texturesize,(global.sl_castlist[i2,7]-__view_get( e__VW.YView, global.sl_viewid )+sl_buffer_ymargin)*sl_buffer_texturesize,global.sl_castlist[i2,9]*sl_buffer_texturesize,global.sl_castlist[i2,10]*sl_buffer_texturesize,global.sl_castlist[i2,11],c_black,global.sl_castlist[i2,12]);
    
    draw_set_blend_mode_ext(bm_inv_dest_color,bm_inv_src_color);
    draw_set_color(c_white);
    draw_rectangle(0,0,(__view_get( e__VW.WView, global.sl_viewid )+sl_buffer_xmargin*2)*sl_buffer_texturesize,(__view_get( e__VW.HView, global.sl_viewid )+sl_buffer_ymargin*2)*sl_buffer_texturesize,0);
...
if sl_sunshadows_refresh && sl_sunshadows_refreshcounter<=0
{
    ...
    if sl_sunshadows_light < 1
    {
        ...
        {
            sl_sunshadows_surface1[0] = surface_create((__view_get( e__VW.WView, global.sl_viewid )+sl_sunshadows_margin*2)*sl_sunshadows_texturesize,(__view_get( e__VW.HView, global.sl_viewid )+sl_sunshadows_margin*2)*sl_sunshadows_texturesize);
            sl_sunshadows_surface1[1] = surface_create((__view_get( e__VW.WView, global.sl_viewid )+sl_sunshadows_margin*2)*sl_sunshadows_texturesize,(__view_get( e__VW.HView, global.sl_viewid )+sl_sunshadows_margin*2)*sl_sunshadows_texturesize);
            sl_sunshadows_surface2    = surface_create((__view_get( e__VW.WView, global.sl_viewid )+sl_buffer_xmargin*2)*sl_buffer_texturesize,(__view_get( e__VW.HView, global.sl_viewid )+sl_buffer_ymargin*2)*sl_buffer_texturesize);
        }
        ...
        for (i1=0; i1<sl_layers_count; i1+=1)
        {
            ...
            {
                sl_xx = lengthdir_x(1+global.sl_z[sl_sunshadows_list[i2,1]]*sl_sunshadows_length,sl_sunshadows_direction)-__view_get( e__VW.XView, global.sl_viewid )+sl_sunshadows_margin;
                sl_yy = lengthdir_y(1+global.sl_z[sl_sunshadows_list[i2,1]]*sl_sunshadows_length,sl_sunshadows_direction)-__view_get( e__VW.YView, global.sl_viewid )+sl_sunshadows_margin;
            ...
            {
                sl_r  = 1;
                sl_xx = lengthdir_x(1+global.sl_castlist[i2,8]*sl_sunshadows_length,sl_sunshadows_direction)-__view_get( e__VW.XView, global.sl_viewid )+sl_sunshadows_margin;
                sl_yy = lengthdir_y(1+global.sl_castlist[i2,8]*sl_sunshadows_length,sl_sunshadows_direction)-__view_get( e__VW.YView, global.sl_viewid )+sl_sunshadows_margin;
            ...
            {
                sl_xx = lengthdir_x(global.sl_z[sl_sunshadows_texlist[i2,1]]*sl_sunshadows_length,sl_sunshadows_direction)-__view_get( e__VW.XView, global.sl_viewid )+sl_buffer_xmargin;
                sl_yy = lengthdir_y(global.sl_z[sl_sunshadows_texlist[i2,1]]*sl_sunshadows_length,sl_sunshadows_direction)-__view_get( e__VW.YView, global.sl_viewid )+sl_buffer_ymargin;
            ...
            draw_sprite_ext(global.sl_texlist_shad[i2,1],global.sl_texlist_shad[i2,2],(global.sl_texlist_shad[i2,3]-__view_get( e__VW.XView, global.sl_viewid )+sl_buffer_xmargin)*sl_buffer_texturesize,(global.sl_texlist_shad[i2,4]-__view_get( e__VW.YView, global.sl_viewid )+sl_buffer_ymargin)*sl_buffer_texturesize,global.sl_texlist_shad[i2,5]*sl_buffer_texturesize,global.sl_texlist_shad[i2,6]*sl_buffer_texturesize,global.sl_texlist_shad[i2,7],c_black,global.sl_texlist_shad[i2,8]);
            ...
            if i1+1 = sl_layers_count
            {
                ...
                draw_rectangle_color(0,0,(__view_get( e__VW.WView, global.sl_viewid )+sl_buffer_xmargin*2)*sl_buffer_texturesize,(__view_get( e__VW.HView, global.sl_viewid )+sl_buffer_ymargin*2)*sl_buffer_texturesize,c_white,c_white,c_white,c_white,0);
                draw_set_alpha(1);
            }
            surface_reset_target();
        }
...
{
    if !surface_exists(sl_ambientshadows_surface) sl_ambientshadows_surface = surface_create((__view_get( e__VW.WView, global.sl_viewid )+sl_buffer_xmargin*2)*sl_buffer_texturesize,(__view_get( e__VW.HView, global.sl_viewid )+sl_buffer_ymargin*2)*sl_buffer_texturesize);
...
for (i1=0; global.sl_lightlist[i1]!=-1; i1+=1) with global.sl_lightlist[i1]
{
    ...
    if sl_light_active
    && sl_light_x < __view_get( e__VW.XView, global.sl_viewid )+__view_get( e__VW.WView, global.sl_viewid )+sl_sz*sl_light_xscale && sl_light_x > __view_get( e__VW.XView, global.sl_viewid )-sl_sz*sl_light_xscale
    && sl_light_y < __view_get( e__VW.YView, global.sl_viewid )+__view_get( e__VW.HView, global.sl_viewid )+sl_sz*sl_light_yscale && sl_light_y > __view_get( e__VW.YView, global.sl_viewid )-sl_sz*sl_light_yscale
    { 
...
draw_rectangle_color(0,0,(__view_get( e__VW.WView, global.sl_viewid )+sl_buffer_xmargin*2)*sl_buffer_texturesize,(__view_get( e__VW.HView, global.sl_viewid )+sl_buffer_ymargin*2)*sl_buffer_texturesize,sl_ambient_color,sl_ambient_color,sl_ambient_color,sl_ambient_color,0);
draw_set_alpha(1);
...
draw_rectangle_color(0,0,(__view_get( e__VW.WView, global.sl_viewid )+sl_buffer_xmargin*2)*sl_buffer_texturesize,(__view_get( e__VW.HView, global.sl_viewid )+sl_buffer_ymargin*2)*sl_buffer_texturesize,c_black,c_black,c_black,c_black,0);
draw_set_alpha(1);
