...
if (global.playerId == self.playerId)
{
		...
		if(mouse_check_button_released(obj_controller_parent.k_bindFire1) && collision_circle(mouse_x,mouse_y,10,all,false,false) && instanceSelected==false)
		{
			mouse_clear(obj_controller_parent.k_bindFire1);
			instanceSelected = collision_circle(mouse_x,mouse_y,10,all,false,false);
		}
		else if (mouse_check_button_released(obj_controller_parent.k_bindFire1) && instanceSelected!=false)
		{
			mouse_clear(obj_controller_parent.k_bindFire1);
		...
		if(mouse_check_button_released(obj_controller_parent.k_bindFire2) && collision_circle(mouse_x,mouse_y,10,all,false,false) && instanceSelected==false){
			mouse_clear(obj_controller_parent.k_bindFire2);
