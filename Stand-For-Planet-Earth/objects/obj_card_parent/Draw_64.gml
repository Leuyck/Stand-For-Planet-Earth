	...
	with(obj_persoBar){
		if(self.hero == other.carryBy){
			if(other.object_index == obj_card_green){
				var xpos = self.x+(150*display_get_width())/1920;
				var ypos = self.y-(30*display_get_height())/1080;
				...
				var xpos = self.x+(170*display_get_width())/1920;
				var ypos = self.y-(32*display_get_height())/1080;
				draw_sprite_ext(other.sprite_index,other.image_index,xpos,ypos,0.5,0.5,0,c_white,1)
			}
		}
	}
